...
public class Iteminit {
	...
	public static final RegistryObject<SpecialItem> GUN_ITEM = ITEMS.register("gun_item", 
			() -> new SpecialItem(new Item.Properties().tab(ItemGroup.TAB_MISC).setISTER(() -> LaserGunRenderer::new)));
